...
function App() { 
  ...
  const handleEdit = (e, id)=>{ 
    ...
    // setTodo(t.todo)
    //when we want a single leemnt not an array
  ...
  const handleAdd= ()=>{
    ...
    //keeping todos array intact and adding an of identites...shown abhove
    setTodo("") 
    saveToLS()
  }
        ...
        <h1 className='font-bold text-center text-3xl'>iTask - Manage your todos at one place</h1>
         ...
         <div className="todos">
          ...
          return (showFinished || !item.isCompleted) && <div key={item.id} className={"todo flex my-3 justify-between"}>
            ...
            each check box has and id the name contains it
            </div>
